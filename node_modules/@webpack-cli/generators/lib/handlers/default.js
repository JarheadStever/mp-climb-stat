...
async function questions(self, Question) {
    ...
    if (cssType == 'none') {
        self.answers = Object.assign(Object.assign({}, self.answers), { cssType, isCSS: false, isPostCSS: false });
        return;
    }
    ...
    self.answers = Object.assign(Object.assign({}, self.answers), { cssType, isCSS, isPostCSS });
}
